...
- **`occtkit`** (executable): a single multi-call binary bundling 29 headless verbs across domains.
  `occtkit --verbs` prints the authoritative list, backed by `Registry.all`; the per-verb reference
  is `docs/reference/occtkit-verbs.md`.
  - **Script host**: `run`
