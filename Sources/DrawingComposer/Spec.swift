...
public struct SheetSpec: Codable, Sendable {
    ...
    public init(
        size: PaperSizeName, orientation: OrientationName,
        ...
        self.scale = scale
        self.border = border
        self.projectionSymbol = projectionSymbol
    }
}
...
public struct CosmeticThreadSpec: Codable, Sendable {
    ...
    public init(
        view: String, axisStart: [Double], axisEnd: [Double],
...
public struct SurfaceFinishSpec: Codable, Sendable {
    ...
    public init(
        view: String, position: [Double], leaderTo: [Double],
...
public struct GDTSpec: Codable, Sendable {
    ...
    public init(
        view: String, position: [Double], symbol: String, tolerance: String,
...
public struct DetailViewSpec: Codable, Sendable {
    ...
    public init(
        name: String, fromView: String, centre: [Double], radius: Double,
...
public struct DimensionSpec: Codable, Sendable {
    ...
    public init(
        view: String, type: DimensionKind,
