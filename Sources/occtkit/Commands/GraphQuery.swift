...
enum GraphQueryCommand: Subcommand {
    static let name = "graph-query"
    static let summary = "Emit a JSON topology summary from a BREPGraph SQLite db"
    static let usage = "Usage: graph-query <graph.sqlite>"
